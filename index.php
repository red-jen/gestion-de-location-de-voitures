...
<body class="bg-gray-100">
    <nav class="bg-blue-600 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="space-x-4">
                <a href="clients.php" class="hover:text-gray-200">Clients</a>
                <a href="cars.php" class="hover:text-gray-200">Voitures</a>
                <a href="rentals.php" class="hover:text-gray-200">Locations</a>
            </div>
        </div>
    </nav>
